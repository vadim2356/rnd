...
export interface PriceSystemType {
  ...
  types: string[];
  varieties: string[];
  /** Опционально: путь к фото карточки (например /images/prices/ro-300.webp) */
  image?: string;
...
export const PRICES_SYSTEM_TYPES: PriceSystemType[] = [
  {
    ...
    image: "/images/prices/soft-1252.webp",
    description:
  ...
  },
  {
    ...
    image: "/images/prices/complex-1252.webp",
    description:
  ...
  },
  {
    ...
    image: "/images/prices/ro-300.webp",
    description:
  ...
  {
    title: "Фильтр для питьевой воды под мойку",
    priceFrom: 4560,
    priceLabel: "от 4 560 ₽",
    image: "/images/prices/pod-moiky2.webp",
    description:
      "Компактный фильтр для питьевой воды под мойку — решение для квартир и домов с центральным водопроводом. Обеспечивает очистку воды от хлора, механических примесей и улучшает вкус. Устанавливается под раковину, отдельный кран для чистой воды на мойке. Сменные картриджи с разной степенью очистки: механическая, угольная, умягчение. Подходит для питьевой воды и приготовления пищи.",
    types: [
      "Многоступенчатая очистка — механическая, угольная, опционально умягчение.",
      "Установка под мойку с отдельным краном для чистой воды.",
      "Сменные картриджи — разный ресурс в зависимости от ступеней.",
      "Для квартиры и дома с центральным водопроводом.",
    ],
    varieties: ["под мойку", "питьевая вода", "квартира", "дом", "картриджи", "кран на мойку"],
    principleWork: [
      "Вода проходит через сменные картриджи (механика, уголь, при необходимости умягчение).",
      "Удаляются хлор, взвеси, улучшается вкус и запах.",
      "Чистая вода подаётся через отдельный кран на мойке.",
    ],
    characteristics: [
      "Тип: проточный фильтр под мойку",
      "Ступени: 2–3 (механика, уголь, опционально умягчение)",
      "Ресурс картриджей: по инструкции производителя",
      "Подключение: к холодной воде под раковиной",
      "Отдельный кран для чистой воды на мойке",
    ],
    advantages: [
      "Компактное размещение под мойкой",
      "Улучшение вкуса и запаха воды",
      "Доступная цена и простое обслуживание",
      "Быстрая установка за один визит",
    ],
    applications: [
      { subtitle: "Квартира", text: "Питьевая вода и приготовление пищи без лишних ступеней очистки." },
      { subtitle: "Дом", text: "Дополнение к основной системе или отдельная точка для кухни." },
    ],
    equipment: [
      "Корпус с картриджами",
      "Кран для чистой воды",
      "Соединительные шланги и фитинги",
      "Монтажные крепления",
    ],
    equipmentOptional: [
      "Дополнительная ступень умягчения",
      "Запасной набор картриджей",
    ],
    mountingLaunch:
      "Установка под ключ: подключение к холодной воде под раковиной, вывод крана на мойку, проверка герметичности и инструктаж по замене картриджей. Работаем в Ростове-на-Дону и области.",
    servicing:
      "Регулярная замена картриджей по ресурсу (срок зависит от ступеней и расхода воды). Рекомендуем заказывать сменные картриджи заранее.",
    faq: [
      { question: "Как часто менять картриджи?", answer: "По ресурсу производителя — обычно от 3 до 6 месяцев в зависимости от расхода и качества воды." },
      { question: "Подходит для скважины?", answer: "Для скважины лучше рассмотреть комплексную систему; под мойку оптимален при центральном водопроводе." },
    ],
  },
];
